...
//numberKwh=200 (200kwh ==> 372)
console.log(calculateElectricityBill(200));
//200<numberKwh<300 (250kwh ==> 498.8)
console.log(calculateElectricityBill(250));
//numberKwh=300 (300kwh ==> 625.6)
console.log(calculateElectricityBill(300));
//300<numberKwh<400 (350kwh ==> 767.3)
console.log(calculateElectricityBill(350));
//numberKwh=400 (400kwh ==> 909)
console.log(calculateElectricityBill(400));
//numberKwh>400 (600kwh ==> 1494.4)
console.log(calculateElectricityBill(600));
...
console.log("test case for exercise 03: ");
//test case incorrect n ==> return n không hợp lệ!!
console.log(calculateExpressionValue("5"));
console.log(calculateExpressionValue(-1));
//test case correct n
//n=4 ==> return 40
console.log(calculateExpressionValue(4));
//n = 10 ==> return 440
console.log(calculateExpressionValue(10));
...
console.log("test case for exercise04: ");
//test case incorrect number
console.log(checkPrimes(0));
console.log(checkPrimes("10"));
//test case correct number
//test case is primes
console.log(checkPrimes(5));
// test case is not primes
console.log(checkPrimes(10));
...
// test case incorrect n
console.log(calculateEx8(0));
console.log(calculateEx8("4"));
//test case correct n
// n = 4 ==> 2.0833333333
console.log(calculateEx8(4));
// n = 7 ==> 2.592857143
console.log(calculateEx8(7));
