  ...
  return (
    <div>
      ...
      <div className="max-w-[1250px] pl-[25px] pr-[25px] mx-auto">
        ...
        >
          <swiper-slide>
            <div className="flex flex-col items-center shadow-2xl p-4">
              <img
                src={`https://api-pages.vercel.app${data.reviewuser.src1}`}
                className="w-[200px] h-[200px] rounded-[50%] mb-[26px]"
                alt=""
              />
          ...
          <swiper-slide>
            <div className="flex flex-col items-center shadow-2xl p-4">
              <img
                src={`https://api-pages.vercel.app${data.reviewuser.src2}`}
          ...
          <swiper-slide>
            <div className="flex flex-col items-center shadow-2xl p-4">
              <img
                src={`https://api-pages.vercel.app${data.reviewuser.src3}`}
                className="w-[200px] rounded-[50%] mb-[26px]"
                alt=""
              />
              <h3 className="text-2xl font-bold">Some People</h3>
          ...
          <swiper-slide>
            <div className="flex flex-col items-center shadow-2xl p-4">
              <img
                src={`https://api-pages.vercel.app${data.reviewuser.src4}`}
                className="w-[200px] rounded-[50%] mb-[26px]"
                alt=""
              />
              <h3 className="text-2xl font-bold">Some People</h3>
