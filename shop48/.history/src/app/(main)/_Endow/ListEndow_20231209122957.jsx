      ...
      <div className="max-w-[1250px] pl-[25px] pr-[25px] mx-auto grid grid-cols-3 gap-3 mt-[40px]">
        <div>
          ...
          <div className="p-4 border w-full text-based">
            <h2 className="flex text-2xl flex items-center mb-[20px] line-through">
              <svg
            ...
            <div className="text-2xl">
              70.000.000 <span className="text-base">83.534.978</span>
            </div>
            <button className="p-2 pl-2 pr-2 mt-[10px] bg-orange-500">
              Đặt Ngay
            </button>
          </div>
        </div>
