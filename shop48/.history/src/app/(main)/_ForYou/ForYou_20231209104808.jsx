  ...
  return (
    <div>
      ...
      <div className="max-w-[1250px] pl-[25px] pr-[25px] mx-auto">
        <img src="https://picsum.photos/1500/360" alt="" />
        <div className="border p-6 text-xl">
          <h2 className="font-bold text-2xl mb-[14px]">Tokyo</h2>
          ...
          <button className="py-px-2 px-px-4 bg-orange-500">Đặt ngay</button>
        </div>
      </div>
    </div>
  );
