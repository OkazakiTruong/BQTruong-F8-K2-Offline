...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-white text-xs pl-6 pr-6 pt-16 grid grid-cols-2 gap-10 md:grid-cols-2 md:text-base lg:grid-cols-4">
      ...
      <div>
        <h2 className="font-bold text-base mb-4">Chi nhánh chính</h2>
        <ul>
          <li>Hà Nội</li>
          <li>Ấn độ</li>
          <li>Mỹ</li>
      ...
      <div>
        <h2 className="font-bold text-base mb-4">Chuyển hướng</h2>
        <ul>
          <li>Trang chủ</li>
          <li>Đặt lịch</li>
          <li>Ưu Đãi</li>
      ...
      <div>
        <h2 className="font-bold text-base mb-4">Tương tác</h2>
        <ul>
          <li>Trang chủ</li>
          <li>Instagram</li>
          <li>Twitter</li>
