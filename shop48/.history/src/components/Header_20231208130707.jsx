  ...
  return (
    <header>
      <nav className="max-w-screen-md fixed inset-x-0 bg-black bg-opacity-70 p-6 text-white flex flex-wrap justify-between items-center select-none md:flex-nowrap md:max-w-full">
        <button type="button" className="flex items-center md:hidden ">
          <svg
        ...
        <ul
          className={
            menuOpen
              ? "flex flex-col order-4 text-lg gap-x-4 w-full md:flex md:flex-row md:order-1 md:w-f md:items-center md:justify-center md:flex"
              : "hidden flex flex-col order-4 text-lg gap-x-4 w-full md:flex md:flex-row md:order-1 md:w-f md:items-center md:justify-center md:flex"
          }
          id="menu-mobile"
        >
