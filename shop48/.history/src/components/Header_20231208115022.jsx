...
export default function Header() {
  ...
  return (
    <header>
      <nav className="fixed inset-x-0 bg-black bg-opacity-70 p-6 text-white flex justify-between item-center select-none">
        <div className="text-2xl font-bold">
          <span className="text-orange-400">S</span>
          TRAVEL
        </div>
        <ul className="flex item-center text-xl gap-x-4 md:display-none">
