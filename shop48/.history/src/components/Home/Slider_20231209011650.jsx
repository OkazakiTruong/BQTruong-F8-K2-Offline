...
export default function Slider() {
  ...
  return (
    <div className="relative">
      <div className="absolute z-40 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-white flex flex-col items-center">
        <h1 className="text-4xl mb-[20px]">Mọi chuyến đi đều đáng giá</h1>
        <p className="text-center text-2xl mb-[20px]">
          Khám phá các vùng đát mới cùng chúng tôi <br />
          Những chuyến đi đang chờ đợi bạn
        </p>
        <button className="p-3 pl-6 pr-6 bg-orange-500">Khám phá ngay</button>
      </div>
      <swiper-container
        loop="true"
        slides-per-view="1"
