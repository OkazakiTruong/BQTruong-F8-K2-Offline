  ...
  return (
    <header>
      <nav className="max-w-screen-md fixed inset-x-0 bg-black bg-opacity-70 p-6 text-white flex flex-wrap justify-between items-center select-none md:flex-nowrap md:max-w-full">
        ...
        <div className="absolute bottom-0 translate-y-[100.1%] left-0 w-full p-2  bg-black bg-opacity-70 flex items-center gap-x-5 justify-center">
          <input
            type="text"
            className="p-3 w-[90%]"
          ...
          <button>
            <svg
              ...
              viewBox="0 0 24 24"
              strokeWidth={2}
              stroke="currentColor hover:color-orange-500"
              className="w-6 h-6 "
            >
              <path
                strokeLinecap="round"
