...
export default function Header() {
  ...
  return (
    <header>
      <nav className="max-w-screen-md fixed inset-x-0 bg-black bg-opacity-70 p-6 text-white flex justify-between items-center select-none">
        ...
        <ul className="flex flex-col justify-between items-center text-xl gap-x-4 w-full  md:flex md:flex-row">
