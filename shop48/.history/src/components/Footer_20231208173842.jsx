...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-white pl-6 pr-6 pt-16 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
      <div>
      ...
      <div>
        <h2 className="font-bold text-xl mb-6">Chi nhánh chính</h2>
        <ul>
          <li>Hà Nội</li>
          <li>Ấn độ</li>
          <li>Mỹ</li>
