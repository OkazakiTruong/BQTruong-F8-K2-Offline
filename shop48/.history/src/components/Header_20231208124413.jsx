...
export default function Header() {
  ...
  return (
    <header>
      <nav className="max-w-screen-md fixed inset-x-0 bg-black bg-opacity-70 p-6 text-white flex flex-wrap justify-between items-center select-none md:flex-nowrap">
        ...
        <ul className="flex flex-col order-4 text-lg gap-x-4 w-full md:flex md:flex-row md:order-2">
