...
let tasks = thingTodoList.querySelectorAll(".task");
let listDeleteTasks = thingTodoList.querySelectorAll(".delete-task");
let listThingTodoItem = thingTodoList.querySelectorAll(".thing-todo-item");
...
const addNewTask = function () {
  ...
  if (checkTaskBeforeAdd(newTask.value)) {
    ...
    listDeleteTasks = thingTodoList.querySelectorAll(".delete-task");
    listThingTodoItem = thingTodoList.querySelectorAll(".thing-todo-item");
    finishATask(tasks);
