...
const tasks = setInterval(function () {
  return thingTodoList.querySelectorAll(".task");
}, 500);
console.log(tasks);
...
const addNewTask = function () {
  ...
  if (checkTaskBeforeAdd(newTask.value)) {
    ...
    const listTask = thingTodoList.querySelectorAll(".task");
    Object.assign(tasks, listTask);
  }
};
