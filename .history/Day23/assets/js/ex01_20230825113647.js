...
const iconShowPassWord = document.querySelectorALL(
  ".icon-show-password.show-password-login i"
);
...
showPasswordLogin.addEventListener("click", function () {
  if (passwordLogin.type === "password") {
    ...
    iconShowPassWord[1].classList.add("show");
    iconShowPassWord[0].classList.remove("show");
  } else {
    passwordLogin.type === "password";
    iconShowPassWord[1].classList.remove("show");
    iconShowPassWord[0].classList.add("show");
  }
});
