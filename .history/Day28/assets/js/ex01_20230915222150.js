...
const loadLyric = function () {
  ...
  for (let i = 0; i < lyricSentences.length - 1; i++) {
    ...
    let startTime2 = lyricSentences[i + 1].startTime;

    let stopTime1 = lyricSentences[i].stopTime;
    let stopTime2 = lyricSentences[i + 1].stopTime;
    let stopTime = startTime2 - stopTime1 > 5000 ? stopTime1 : stopTime2;
    if (
