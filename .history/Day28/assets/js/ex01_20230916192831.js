...
let json = `
{
  ...
  "data": {
    ...
    "file": "https://static-zmp3.zmdcdn.me/lyrics/6/d/e/a/6dea402284a1d4cf213844b861b39be0.lrc",
    "beat": "https://mcloud-bf-s9-audio-zmp3.zmdcdn.me/bVclLaCJ6A4/172be056f78d1cd3459c/9fbac40affde14804dcf/96/accompaniment.m4a?authen=exp=1694945422~acl=/bVclLaCJ6A4/*~hmac=2f40ed08f10741c2e9595beb1860553b",
    "enabledVideoBG": true,
    "defaultIBGUrls": [
...
const loadLyric = function () {
  ...
  for (let i = 0; i < lyricSentences.length - 1; i++) {
    ...
    let stopTime;
    if (lyricSentences[i + 1].startTime - lyricSentences[i].stopTime <= 10000) {
      stopTime = lyricSentences[i + 1].stopTime;
      i++;
    } else {
      stopTime = lyricSentences[i].stopTime;
    }
    // if (
