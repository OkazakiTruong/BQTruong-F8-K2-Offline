...
function moveToNextQuestion() {
  ...
  if (questionNumber <= allQuestions) {
    isCountDown = true;
    const questionNumberEle = document.querySelector(
      ".number-question span:nth-child(1)"
    );
    questionNumberEle.innerText = questionNumber;
    ...
    <div class="score-screen">
      <div>
        ...
        <div class="steak-wrapper">
          <div class="steak">
            <div class="steak-init ${steak > 0 ? "active" : ""}">Steak</div>
          </div>
