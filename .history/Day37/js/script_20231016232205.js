...
const renderGameScreen = async () => {
  ...
  let { data: question, response } = await client.get(`/questions?${params}`);
  ...
  let html = `
    ...
    <div class="question">${question[0].question}</div>
    <div class="answers">
      <div class="answer">${question[0].answer[0]}</div>
      <div class="answer">${question[0].answer[1]}</div>
      <div class="answer">${question[0].answer[2]}</div>
      <div class="answer">${question[0].answer[3]}</div>
    </div>
  </div>
