...
const renderGameScreen = async () => {
  ...
  let html = `
    ...
    <div class="answers">
      <div class="answer">${question.answer[0]}</div>
      <div class="answer">${question.answer[1]}</div>
      <div class="answer">${question.answer[2]}</div>
      <div class="answer">${question.answer[3]}</div>
    </div>
  </div>
