      ...
      results.forEach((result) => {
        if (result.match(/youtube/)) {
          ...
          content.innerHTML = content.innerHTML.replace(
            result,
            `<iframe width="560" height="315" title="YouTube video player" src="${embedLinkYt}" frameborder="0" accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share allowfullscreen></iframe>`
          );
        } else {
          content.innerHTML = content.innerHTML.replace(
            result,
