...
let cartProducts = [];
const getAllCartProducts = function () {
  cartProducts = JSON.parse(localStorage.getItem("cartProducts")===null?[]:JSON.parse(localStorage.getItem("cartProducts"));
};
getAllCartProducts();
...
// const showCartProc = function () {
//   tableCartProc.forEach((product) => {
