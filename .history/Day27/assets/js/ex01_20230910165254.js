...
const showCartProduct = function () {
  number = 0;
  //   Array.from(tableCartProc.children).forEach(function (node) {
  //     console.log(node);
  //   });
  cartProducts.forEach(function (product) {
    const cartTbody = document.createElement("tbody");
    ...
    cartTbody.append(tr);
    tableCartProc.insertBefore(cartTbody, tableEnd);
  });
};
showCartProduct();
