...
boldOption.addEventListener("click", function () {
  if (window.getSelection().toString() !== "") {
    ...
    let html =
      editorMain.innerText.slice(0, startAnchor) +
      "<b>" +
      editorMain.innerText.slice(startAnchor, endAnchor) +
      "</b>" +
      editorMain.innerText.slice(endAnchor);
    editorMain.innerHTML = html.innerText;
    console.log();
  }
});
